...
% ICPC Moscow (2020) was postponed by a year because of the covid situation
% Due to the COVID situation, these teams got mixed:
\newcommand{\teamname}{Utrecht University - Leiden University}
\newcommand{\university}{Utrecht - Leiden University}

% Header/Footer
%\geometry{includeheadfoot}
%\fancyhf{}
\pagestyle{fancy}
\lhead{\university, \teamname}
\chead{}
...
\title{TCR}
\subtitle{\textbf{\teamname} \\ \textit{Ludo Pulles, Reinier Schmiermann, Jorke de Vlas}}
...
Works with characters in ASCII range $[64, 128)$.
